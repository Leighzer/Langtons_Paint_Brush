...
//There is a saved color using a few variables, and every time the ant moves, the color is randomly changed by a small amount
...
int colorDifferential; //variable to hold the delta value that we will change the color by after the ant updates
